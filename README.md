...
以下两图描述的是面试用目标架构，不代表当前 Demo 已生产部署；完整说明见 [架构母文档](架构/AI_CLEANING_INSPECTION_ARCHITECTURE_MASTER.md)。

[![AI 自主清洁与移动巡检全量业务流程](架构/业务流程图.png)](架构/业务流程图.html)

[![AI 自主清洁与移动巡检全量技术架构](架构/技术架构图.png)](架构/技术架构图.html)
