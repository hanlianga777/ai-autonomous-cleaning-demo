...
import { FLOATING_EXPANDED_KEY, FLOATING_POSITION_KEY, actionLabel, adviceWindowLabel, clampFloatingPosition, defaultFloatingPosition, parseStoredPosition, readStorage, recentTasks, taskActions, taskExecutorLabel, taskKindLabel, taskLocationLabel, taskStatusLabel, writeStorage, type AgentAudit, type OperationsTask } from "./robotOperationsModel";
