...
export const cameras: Record<string, Camera> = {
  "CAM-OUT-01": {
    ...
    overlay: [{ label: "地面纸巾", confidence: 0.94, bbox: [716 / 1448, 675 / 1086, 775 / 1448, 716 / 1086] }],
  },
  "CAM-A1-01": {
    id: "CAM-A1-01", location: "A栋1F大堂",
    image: asset("CAM-A1-01", "event-beverage-spill-002", "primary.png"),
    overlay: [{ label: "液体污渍", confidence: 0.62, bbox: [643 / 1448, 544 / 1086, 827 / 1448, 641 / 1086] }],
  },
  "CAM-A1-02": {
    id: "CAM-A1-02", location: "A栋1F入口补充视角",
    image: asset("CAM-A1-02", "event-beverage-spill-002", "secondary.png"),
    overlay: [{ label: "液体疑似区域", confidence: 0.66, bbox: [684 / 1448, 529 / 1086, 802 / 1448, 617 / 1086] }], temporary: true,
  },
  "CAM-A1-04": {
    id: "CAM-A1-04", location: "A栋1F休息区补充视角",
    image: asset("CAM-A1-04", "event-beverage-spill-002", "secondary.png"),
    overlay: [{ label: "液体疑似区域", confidence: 0.64, bbox: [630 / 1448, 539 / 1086, 817 / 1448, 614 / 1086] }], temporary: true,
  },
  "CAM-A2-08": {
    id: "CAM-A2-08", location: "A栋2F连廊区域",
    image: asset("CAM-A2-08", "event-indoor-can-003", "primary.png"),
    overlay: [{ label: "易拉罐", confidence: 0.92, bbox: [699 / 1448, 695 / 1086, 735 / 1448, 721 / 1086] }],
  },
  "CAM-A2-11": {
    id: "CAM-A2-11", location: "A栋2F公共区域",
    image: asset("CAM-A2-11", "event-oversized-box-004", "primary.png"),
    overlay: [
      { label: "大型纸箱", confidence: 0.94, bbox: [505 / 1448, 570 / 1086, 627 / 1448, 706 / 1086] },
      { label: "大型纸箱", confidence: 0.79, bbox: [604 / 1448, 610 / 1086, 723 / 1448, 729 / 1086] },
    ],
  },
};

export const defaultCameraIds = ["CAM-OUT-01", "CAM-A1-01", "CAM-A2-08", "CAM-A2-11"];
...
export const scenarios: DemoScenario[] = [
  {
    id: "outdoor", triggerLabel: "园区道路 · 小型垃圾", cameraId: "CAM-OUT-01", eventTitle: "园区东侧道路发现小型垃圾", category: "地面纸巾", confidence: 94, qwenConfidence: 93,
  ...
  {
    id: "liquid", triggerLabel: "A栋1F大堂 · 液体污渍", cameraId: "CAM-A1-01", eventTitle: "A栋1F大堂发现液体污渍", category: "液体污渍", confidence: 62, qwenConfidence: 91,
  ...
  {
    id: "can", triggerLabel: "A栋2F连廊区域 · 易拉罐", cameraId: "CAM-A2-08", eventTitle: "A栋2F连廊区域发现易拉罐", category: "易拉罐", confidence: 92, qwenConfidence: 94,
  ...
  {
    id: "oversized", triggerLabel: "A栋公共区域 · 大件物品", cameraId: "CAM-A2-11", eventTitle: "A栋2F公共区域发现大件物品", category: "大型纸箱", confidence: 94, qwenConfidence: 96,
...
export const stageCopy: Record<PrototypeState, { title: string; detail: string }> = {
  ...
  MULTI_VIEW: { title: "补充多视角证据", detail: "Agent 临时调取 2 个关联摄像头进行交叉研判" },
  CLOUD_REVIEW: { title: "云端综合研判完成", detail: "已确认清洁必要性及处置建议" },
  ...
  ELEVATOR_TRANSFER: { title: "机器人正在乘坐电梯", detail: "Robot C 从 B栋1F 转移至 B栋2F" },
  SKYBRIDGE_TRANSFER: { title: "机器人正在通过空中连廊", detail: "Robot C 由 B栋2F 前往 A栋2F" },
