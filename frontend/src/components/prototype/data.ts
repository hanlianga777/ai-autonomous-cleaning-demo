...
export const cameras: Record<string, Camera> = {
  "CAM-OUT-01": {
    ...
    overlay: [{ label: "地面纸巾", confidence: 0.81, bbox: [716 / 1448, 675 / 1086, 775 / 1448, 716 / 1086] }],
  },
  "CAM-A1-01": {
  ...
  "CAM-A2-11": {
    ...
    overlay: [
      { label: "大型纸箱", confidence: 0.82, bbox: [505 / 1448, 570 / 1086, 627 / 1448, 706 / 1086] },
      { label: "大型纸箱", confidence: 0.76, bbox: [604 / 1448, 610 / 1086, 723 / 1448, 729 / 1086] },
    ],
  },
};
...
export const stageCopy: Record<PrototypeState, { title: string; detail: string }> = {
  ...
  MULTI_VIEW: { title: "多视角研判", detail: "Agent 临时调取 2 个关联摄像头进行交叉研判" },
